<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"G:\phpStudy\PHPTutorial\WWW\test1\public/../application/admin\view\post\edit.html";i:1538547618;s:75:"G:\phpStudy\PHPTutorial\WWW\test1\application\admin\view\common\header.html";i:1538470776;s:78:"G:\phpStudy\PHPTutorial\WWW\test1\application\admin\view\common\left_menu.html";i:1538471125;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <section class="top-title">
            <div class="col-md-12 column">
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('post/lst'); ?>">博文列表</a>
                    </li>
                    <li class="active">修改博文</li>
                </ol>
            </div>
        </section>
        <div class="rightbody">
                ...
                <form action="" enctype="multipart/form-data" method="post">
                    ...
                    <div class="myform-line">
                        ...
                        <div class="myform-right">
                            <input class="myform-input" name="title" type="text" value="<?php echo $post['title']; ?>">
                        </div>
                    </div>
                    <div class="myform-line">
                        <label class="myform-left">博文作者：</label>
                        <div class="myform-right">
                            <input class="myform-input" name="author" type="text" value="<?php echo $post['author']; ?>">
                        </div>
                    </div>
                    <div class="myform-line">
                        <label class="myform-left">关键字：</label>
                        <div class="myform-right">
                            <input class="myform-input" name="keywords" type="text" value="<?php echo $post['keywords']; ?>">
                        </div>
                    </div>
                    <div class="myform-line">
                        <label class="myform-left">博文说明：</label>
                        <div class="myform-right">
                            <textarea class="myform-textarea" name="desc"><?php echo $post['desc']; ?></textarea>
                        </div>
                    </div>
                    <div class="myform-line">
                        ...
                        <div class="myform-right">
                            <?php if($post['pic'] != ''): ?>
                            <img  src="http://127.0.0.1/test1/public/static<?php echo $post['pic']; ?>" height="50">
                            <?php else: ?>
                            暂无缩略图
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="myform-line">
                        <label class="myform-left">修改缩略图：</label>
                        <div class="myform-right">
                            <input id="pic" class="myform-input" name="pic" type="file">
                    ...
                    <div class="myform-line">
                        ...
                        <div class="myform-right">
                            <select class="myform-input" name="cateid">
                                ...
                                <option <?php if($vo['id'] == $post['cateid']): ?> selected="selected" <?php endif; ?> value="<?php echo $vo['id']; ?>"><?php echo $vo['catename']; ?></option>
                    ...
                    <div class="myform-line">
                        ...
                        <span class="myform-switch">
                            <input class="hidden" type="checkbox" <?php if($post['state'] == 1): ?> checked="checked" <?php endif; ?> name="state" id="switch-checkbox">
                    ...
                    <div class="myform-line">
                        ...
                        <div class="myform-right">
                            <textarea class="myform-textarea" name="content"><?php echo $post['content']; ?></textarea>
                        </div>
                    </div>
                    <div class="myform-line">
                        <div class="myform-right">
