<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"G:\phpStudy\PHPTutorial\WWW\test1\public/../application/admin\view\admin\info.html";i:1538547732;s:75:"G:\phpStudy\PHPTutorial\WWW\test1\application\admin\view\common\header.html";i:1538470776;s:78:"G:\phpStudy\PHPTutorial\WWW\test1\application\admin\view\common\left_menu.html";i:1538471125;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="myform-form myform-form-wd100">
                    <div class="myform-line">
                        ...
                        <div class="myform-right">
                            <input class="myform-input" name="title" type="text" placeholder="链接标题">
                        </div>
                    </div>
                    <div class="myform-line">
                        <label class="myform-left">链接地址：</label>
                        <div class="myform-right">
                            <input class="myform-input" name="url" type="text" placeholder="链接地址">
                        </div>
                    </div>
                    <div class="myform-line">
                    ...
                    <div class="myform-line">
                        ...
                        <span class="myform-switch">
                            <input class="hidden" type="checkbox" id="switch-checkbox">
                    ...
                    <div class="myform-line">
                        <div class="myform-right">
                            <input class="myform-btn" type="submit" value="确认">
                        </div>
                    </div>
                </div>
