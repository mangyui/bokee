<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"G:\phpStudy\PHPTutorial\WWW\test1\public/../application/admin\view\links\lst.html";i:1538547965;s:75:"G:\phpStudy\PHPTutorial\WWW\test1\application\admin\view\common\header.html";i:1538470776;s:78:"G:\phpStudy\PHPTutorial\WWW\test1\application\admin\view\common\left_menu.html";i:1538471125;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="rightbody">
                <table class="mytable">
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        ...
                        <td>
                            <a href="<?php echo url('links/edit',array('id'=>$vo['id'])); ?>" class="label label-warning">
                                <span class="glyphicon glyphicon-edit"></span>编辑</a>
                            <a  onclick="layerwaring('确定要删除吗','<?php echo url('links/del',array('id'=>$vo['id'])); ?>')" class="label label-danger">
