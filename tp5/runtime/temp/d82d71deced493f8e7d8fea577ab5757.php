        ...
        <section class="top-title">
            <div class="col-md-12 column">
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('cate/lst'); ?>">栏目列表</a>
                    </li>
                ...
                <form action="" method="post">
                    ...
                    <div class="myform-line">
                        ...
                        <div class="myform-right">
                            <input class="myform-input" name="catename" type="text" value="<?php echo $cate['catename']; ?>">
                        </div>
                    </div>
                    <div class="myform-line">
                        <label class="myform-left">栏目说明：</label>
                        <div class="myform-right">
                            <textarea class="myform-textarea" name="desc" ><?php echo $cate['desc']; ?></textarea>
                        </div>
                    </div>
                    <div class="myform-line">
                        <div class="myform-right">
